...
href="../mobile/share.php"
	...
	>Share</a></li>
		...
		<ul data-role="listview">
            ...
            <?php foreach ($categories as $category) : ?>
                ...
                <a href="?category_id=<?php echo $category['categoryID']; ?>">
                	...
                	<ul data-role="listview">
                     ...
                     <a href="?sort_id=code">Code
                     </a>
            
                   
                      <a href="?sort_id=<?php echo name; ?>">
                    <?php echo name; ?>
                   </a>
                       <a href="?sort_id=<?php echo price; ?>">
           ...
           <span class="ui-li-count ui-btn-up-c ui-btn-corner-all"><?php echo $product['listPrice']; ?>
